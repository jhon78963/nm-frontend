...
- Name: qa-integration.spec.ts >> QA — Seguridad warehouse / admin / payroll (SEC-025) >> usuario sin permiso team.getPaymentByMonth no puede acceder a payroll
- Location: tests-e2e/qa-integration.spec.ts:216:7
